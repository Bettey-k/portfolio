...
const Services = () => {
  return (
    <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <h2 className="text-center text-5xl font-bold font-Ovo"> My Services</h2>
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        I am a frontend developer In Ethiopia, with 3 years Experience in
        Multiple Companies like Hagbes pvt.ltd and Amhara Bank Sc.
      </p>
